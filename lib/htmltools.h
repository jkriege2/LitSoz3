 ...
 */
LITSOZ3TOOLS_EXPORT QMap<QString, QVariant> extractMetadataFromHTML(const QString& data, const QSet<QString>& name_prefixes, const QSet<QString>& name_additions, const QList<QString>& ands);
/** \brief same as extractMetadataFromHTML(), but does not extract COinS metadata */
LITSOZ3TOOLS_EXPORT QMap<QString, QVariant> extractHTMLMetadata(const QString& data, const QSet<QString>& name_prefixes, const QSet<QString>& name_additions, const QList<QString>& ands);
...
/*! \brief extract metadata encoded in OpenURL COinS, as a list of records
  ...
  */
LITSOZ3TOOLS_EXPORT QList<QMap<QString, QVariant> > extractCoins(const QString& data, const QSet<QString>& name_prefixes, const QSet<QString>& name_additions, const QList<QString>& ands);


/*! \brief remove HTML comments from text */
LITSOZ3TOOLS_EXPORT QString removeHTMLComments(const QString& data);
/*! \brief remove HTML markup from text */
LITSOZ3TOOLS_EXPORT QString removeHTML(const QString& data);

LITSOZ3TOOLS_EXPORT QByteArray guessEncoding(const QByteArray& encodingFromReply, const QByteArray& data);
